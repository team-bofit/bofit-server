...
public enum AdditionalInfo {
	...
	MAJOR_DISEASE("큰 병", "3대 중증질환(암, 뇌혈관, 심장)은 발병률이 높고, 치료비 부담도 커요. 진단 즉시 목돈(진단비)이 지급돼 경제적 부담을 줄여줘요."),
	CANCER("암", "일반암(위암, 폐암 등)과 소액암(갑상선암, 전립선암 등)으로 나뉘며, 소액암은 치료비가 저렴하고 완치가 쉽기 때문에 보장금액이 낮게 설정돼요."),
