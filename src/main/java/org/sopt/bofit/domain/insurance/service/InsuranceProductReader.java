...
public class InsuranceProductReader {
	...
	public List<InsuranceProduct> getAgeAndPremiumAndOptionFilteredProducts(
		int age,
		int minPremium,
		int maxPremium,
        InsuranceOptionCommand optionCommand
	){
        return insuranceProductRepository.findAllByAgeAndPremiumAndOptions(age, minPremium, maxPremium, optionCommand);
	}
