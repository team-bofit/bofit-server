...
public enum CoveragePreference {
    ...
    DEATH_BENEFIT("사망 시 가족에게 경제적 도움이 되기를 원해요", "사망 시 가족에게 경제적 도움이 되는 보장을 원해요"),
    ESSENTIAL_ONLY("꼭 필요한 합리적인 보장만 챙기고 싶어요", "합리적인 보험료로 꼭 필요한 보장만 챙기고 싶어요"),
    ...
    RECOMMENDED_OPTION("잘 모르겠어요. 많이 선택하는 걸로 할래요", null)
    ;
