...
public enum InsuranceErrorCode implements ErrorCode{
	...
	NOT_FOUND_RECOMMENDED_STATUS_INSURANCE(HttpStatus.INTERNAL_SERVER_ERROR.value(), "추천 상태의 보험 상품을 찾을 수 없습니다."),
	NOT_FOUND_INSURANCE_PRODUCT(HttpStatus.NOT_FOUND.value(), "보험 상품을 찾을 수 없습니다."),
	;
